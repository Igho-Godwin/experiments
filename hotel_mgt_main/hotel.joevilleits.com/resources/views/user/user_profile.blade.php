            ...
            <div class="container">
                <div class='row background-color-white padding-30px padding-left-30percent' style='width:100%;'>
                    ...
                    <div draggable='false'>  
                       ...
                       <br>
                       <div class='row'>
                          <img src='@if(Auth::user()->picture !='')user_pic/{{Auth::user()->picture}}@else images/default-pic.png @endif' style='border-radius:50%;' /> 
...
<link href="mdb-stepper/css/mdb.min.css" rel="stylesheet">
