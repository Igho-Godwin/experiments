            ...
            <div class="nk-nav-scroll">
                ...
                @if(Auth::user()->dept == '1' or Auth::user()->dept == '7' )
                    ...
                    <li class="mega-menu mega-menu-lg">
                     ...
                     <li class="mega-menu mega-menu-lg">
                        <a class="" href="collectFromStore" aria-expanded="false">
                            <i class="mdi mdi-view-dashboard"></i><span class="nav-text">Collect From Store</span>
                        </a>
                    </li>
                     <li class="mega-menu mega-menu-lg">
                        <a class="" href="allStoreCollections" aria-expanded="false">
                            <i class="mdi mdi-view-dashboard"></i><span class="nav-text">All Store Collections</span>
                        </a>
                    </li>
                    </div>
                    </div>
