...
class RoomTypeController extends BaseController
{
    ...
    public function sellRoom()
    {
        ...
        $rules = [
            ...
            'others' => 'required|max:11',
            'birth_month' => 'required|max:100',
            'birth_day' => 'required|max:31|numeric',
            'phone_number' => 'required|max:99999999999|numeric',
