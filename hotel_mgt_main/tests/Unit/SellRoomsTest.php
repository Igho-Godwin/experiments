...
class SellRoomsTest extends TestCase
{
    /**
     ...
     * @return void
     */
    public function testSellRoomTestWithMiddleware()
    {
       ...
       // factory(OneHourElectricity::class)->make([ 'panel_id' => $panel->id ])->save();
            ...
            $response = $this->actingAs($u_login, 'api')->json('POST', '/api/sell-room',$data);
    ...
    public function testeditFoodTypeWithoutMiddlewareTest()
    {
         $data = [
            ...
            $response = $this->json('POST', '/api/sell-room',$data);
