            ...
            <div class="container">
                <div class='row background-color-white padding-30px padding-left-30percent' style='width:100%;'>
                    ...
                    <div>  
                       ...
                       <br>
                       <form id='collect-storeForm' enctype="multipart/form-data">
                         ...
                         <div class="col-sm-6">
                             <select name='Item_name' class='form-control' id='Item_name' required='' title='Item name'>
                                 ...
                                 @foreach($all_items as $obj1)
                                    <option value='{{$obj1->id}}'>{{$obj1->itemName}}</option>
                                 @endforeach
                             </select>
                         </div>
                         <div class="col-sm-6">
                      ...
                      <div class="form-row">
                       ...
                       <div class="form-row">
                         <div class="col-sm-12">
                             <button type='button' id='collect-FromStore' class='btn-primary padding-5px width-100percent' >
