<style>
        ...
        <!--**********************************
            Nav header start
        ***********************************-->
        <div class="nav-header" style='height:60px!important;'>
            <div class="brand-logo">
                <a href="Dashboard"><b><img src="assets/images/f-logo.png" style='width:30px!important;' height='30'  alt=""></span></a>
            </div>
            <div class="nav-control">
                <div class="hamburger" style='margin-top:-20px;'><span class="line"></span>  <span class="line"></span>  <span class="line"></span>
                </div>
            </div>
        </div>
        <!--**********************************
                    ...
                    <ul>
                        ...
                        <li class="icons">
                            <a href="javascript:void(0)" class="log-user">
                                <img src="@if(Auth::user()->picture=='')images/default-pic.png @else user_pic/{{Auth::user()->picture}}@endif" alt=""> <span>{{Auth::user()->first_name}}</span>  <i class="fa fa-caret-down f-s-14" aria-hidden="true"></i>
                            </a>
                            <div class="drop-down dropdown-profile animated bounceInDown">
                                <div class="dropdown-content-body">
                                    <ul>
                                        <li><a href="user_profile"><i class="icon-user"></i> <span>My Profile</span></a>
                                        </li>
