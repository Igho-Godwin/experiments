...
<?php echo $__env->make('admin.header.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <tbody>
            ...
            <?php $__currentLoopData = $all_admins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            
                <tr>
                    <td><?php echo e($val->first_name); ?></td>
                    <td><?php echo e($val->last_name); ?></td>
                    <td><a href='' data-toggle="modal" data-target="#exampleModal<?php echo e($val->id); ?>" ><?php echo e($val->email); ?></a></td>
                    <td>
                ...
                <div class="modal fade" id="exampleModal<?php echo e($val->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-body">
                             <form id='editAdminForm<?php echo e($val->id); ?>'>
                               
                                <div class='text-center image'>
                                    <img class='picture' class='border-radius-50' src='<?php echo e($val->picture); ?>' style='max-width:200px;max-height:200px;' />
                                    <br>
                                    <input  type='file' name='image' class='image' />
                                    <br>
                                    <input type='text' name='photo' id='photo<?php echo e($val->id); ?>' class='hide' />
                                  
                                </div>
                            
                                <input type='text' id='id' name='id' value='<?php echo e($val->id); ?>' class='hide' />
                                ...
                                <div class='col-sm-12'>
                                    ...
                                    <div class='row'>
                                        <div class='col-sm-6 margin-top-20'>
                                            <input type='text' name='first_name'     class='form-control' required=''     placeholder='First Name' value='<?php echo e($val->first_name); ?>' />
                                        </div>
                                
                                        <div class=' col-sm-6 margin-top-20'>
                                             <input type='text' name='last_name'     class='form-control' required=''     placeholder='Last Name' value='<?php echo e($val->last_name); ?>' />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <button type='button' onclick='editAdminData(<?php echo e($val->id); ?>)' class='btn margin-top-20 btn-primary width-100'>Edit &nbsp; <i class="fa fa-spinner fa-spin hide " aria-hidden="true"></i></button>
    ...
    <div class='float-right'>
        <?php if($all_admins !=null && count($all_admins) > 0): ?>
               <?php echo e($all_admins->links()); ?>
...
</html><?php /**PATH /home/lpg247/public_html/resources/views/admin/all_admins.blade.php ENDPATH**/ ?>