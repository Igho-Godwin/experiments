...
<body>
    ...
    <div id="main-wrapper">
                                ...
                                <ul class="list-style-none">
                                    ...
                                    <li>
                                        <div class="message-center message-body">
                                            ...
                                            <a href="javascript:void(0)" class="message-item">
                                                <span class="user-img">
                                                    <img src="<?php echo e($user->picture); ?>" alt="user" class="rounded-circle">
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">
                                <img src="<?php echo e($user->picture); ?>" alt="user" class="rounded-circle" width="31">
                            </a>
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <div class="d-flex no-block align-items-center p-15 bg-primary text-white m-b-10">
                                    <div class="">
                                        <img src="<?php echo e($user->picture); ?>" alt="user" class="img-circle" width="60">
                                    </div>
                                    <div class="m-l-10">
                                        <h4 class="m-b-0"><?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?></h4>
                                        <p class=" m-b-0"><?php echo e($user->email); ?></p>
                                    </div>
                                </div>
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li>
                            ...
                            <div class="user-profile dropdown m-t-20">
                                <div class="user-pic">
                                    <img src="<?php echo e($user->picture); ?>" alt="users" class="rounded-circle img-fluid" />
                                </div>
                                <div class="user-content hide-menu m-t-10">
                                    <h5 class="m-b-10 user-name font-medium"><?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?></h5>
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse  first-level">
                                ...
                                <li class="sidebar-item">
                                    <a href="all_admins" class="sidebar-link">
                                        <i class="icon-Record"></i>
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item">
                                    <a href="allSalesRep" class="sidebar-link">
                                        <i class="icon-Record"></i>
                                        <span class="hide-menu">All Sales Representative </span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="allMarketers" class="sidebar-link">
                                        <i class="icon-Record"></i>
                                        <span class="hide-menu">All Marketers </span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item">
                                    <a href="createMarketer" class="sidebar-link">
                                        <i class="icon-Record"></i>
                                        <span class="hide-menu">Create Marketer</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="allMarketers" class="sidebar-link">
                        ...
                        <li class="nav-small-cap">
                            <i class="mdi mdi-dots-horizontal"></i>
                            <span class="hide-menu">Percentage Remission</span>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
                                <i class="icon-Car-Wheel"></i>
                            ...
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item">
                                    <a href="addRemission" class="sidebar-link">
                                        <i class="icon-Record"></i>
                                        <span class="hide-menu">Add Percentage Remission</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse  first-level">
                                ...
                                <li class="sidebar-item">
                                    <a href="addRemission" class="sidebar-link">
                                        <i class="icon-Record"></i>
                                        <span class="hide-menu">All Items</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
        ...
        <!-- ===============================================<?php /**PATH /home/lpg247/public_html/resources/views/admin/header/header.blade.php ENDPATH**/ ?>