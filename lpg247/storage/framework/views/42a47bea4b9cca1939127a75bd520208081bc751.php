            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Create Sub Account</h4>
                        ...
                        <div class="d-flex no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Create Sub Account</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 text-center">
                        ...
                        <div class='display-inline-block width-50' >
                           ...
                           <form id='addSubAccountForm'>
                                ...
                                <input type='text' name='user_id' value='<?php echo e(Auth::id()); ?>' class='hide' />
                                
                                <div class='col-sm-12'>
                                    <div class='row'>
                                        <div class='col-sm-12 margin-top-20'>
                                            <input type='text' name='email'         class='form-control' required=''        placeholder='Email Address' value='' />
                                        </div>
                                ...
                                <div class='col-sm-12'>
                                    ...
                                    <div class='row'>
                                        <div class='col-sm-12 margin-top-20'>
                                           <input type='text' name='address'   id='autocomplete' class='form-control' required=''     placeholder='Address' />
                                        </div>
                                    </div>
                                ...
                                <div class='col-sm-12'>
                                    ...
                                    <div class='row'>
                                        <div class='col-sm-12 margin-top-20'>
                                           <input type='text' name='price_per_qty'  class='form-control' required=''     placeholder='<?php if(Auth::user()->marketer_type == 0): ?> Enter Price Per Kilos <?php else: ?> Enter Price Per Tonne <?php endif; ?>' />
                                        </div>
                                    </div>
                                    ...
                                    <div class='row'>
                                        <div class='col-sm-12 margin-top-20'>
                                           <select name='city_of_location' class="form-control">
                                            ...
                                            <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <button type='button' id='addSubAccountBtn' class='btn margin-top-20 btn-primary width-100'>Add &nbsp; <i class="fa fa-spinner fa-spin hide " aria-hidden="true"></i></button>
...
</html><?php /**PATH /home/lpg247/public_html/resources/views/user/marketer/createSubAccount.blade.php ENDPATH**/ ?>