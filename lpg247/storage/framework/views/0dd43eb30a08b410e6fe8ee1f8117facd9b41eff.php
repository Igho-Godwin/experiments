    ...
    <div id="main-wrapper">
        ...
        <header class="topbar">
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">
                                <img src="<?php if(Auth::user()->picture == null): ?>images/default-pic.png <?php else: ?> <?php echo e($marketer_obj->fitImage(Auth::user()->picture,200,200)); ?>  <?php endif; ?>" alt="user" class="rounded-circle" width="31">
                            </a>
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <div class="d-flex no-block align-items-center p-15 bg-primary text-white m-b-10">
                                    <div class="">
                                        <img src="<?php if(Auth::user()->picture == null): ?>images/default-pic.png <?php else: ?> <?php echo e($marketer_obj->fitImage(Auth::user()->picture,200,200)); ?>  <?php endif; ?>" alt="user" class="img-circle rounded-circle" width="60">
                                    </div>
                                    <div class="m-l-10">
                                ...
                                <div class="p-l-30 p-10">
                                    <a href="user_profile" class="btn btn-sm btn-success btn-rounded">View Profile</a>
                                </div>
                            </div>
                        </li>
                        <!-- ============================================================== -->
          ...
          <aside class="left-sidebar">
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li>
                            ...
                            <div class="user-profile dropdown m-t-20">
                                <div class="user-pic">
                                    <img src="<?php if(Auth::user()->picture == null): ?>images/default-pic.png <?php else: ?> <?php echo e($marketer_obj->fitImage(Auth::user()->picture,200,200)); ?>  <?php endif; ?>" alt="users" class="rounded-circle img-fluid" />
                                </div>
                                <div class="user-content hide-menu m-t-10">
                                    <h5 class="m-b-10 user-name font-medium"><?php echo e(Auth::user()->fullName); ?></h5>
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item">
                                    <a href="e_wallet" class="sidebar-link">
                        ...
                        <?php if(Auth::user()->marketer_type == 0 ): ?>
                        
                            <li class="sidebar-item">
                                <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
                                    <i class="icon-Car-Wheel"></i>
                                    <span class="hide-menu">Sub Accounts</span>
                                </a>
                                <ul aria-expanded="false" class="collapse  first-level">
                                    <li class="sidebar-item">
                                        <a href="createSubAccount" class="sidebar-link">
                                            <i class="icon-Record"></i>
                                            <span class="hide-menu"> Create Sub     Account </span>
                                        </a>
                                    </li>
                                    <li class="sidebar-item">
                                        <a href="allSubAccount" class="sidebar-link">
                                            <i class="icon-Record"></i>
                                            <span class="hide-menu">All Sub     Accounts </span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="sidebar-item">
                                ...
                                <ul aria-expanded="false" class="collapse  first-level">
                                    <li class="sidebar-item">
                                        <a href="allMarketersOrdersPage" class="sidebar-link">
                                            <i class="icon-Record"></i>
            ...
            <!-- End Sidebar scroll-->
        </aside><?php /**PATH /home/lpg247/public_html/resources/views/user/header/header.blade.php ENDPATH**/ ?>