                            ...
                            <form class="form-horizontal m-t-20" id="loginUserForm" >
                                ...
                                <div class="form-group text-center">
                                    <div class="col-xs-12 p-b-20">
                                        <button class="btn btn-block btn-lg btn-info login-btn" type="button">Log In &nbsp;<i class='fa fa-spinner fa-spin hide'></i></button>
                                    </div>
                                </div>
                                <div class="row">
                                    <!--
...
</html><?php /**PATH /home/lpg247/public_html/resources/views/user/login.blade.php ENDPATH**/ ?>