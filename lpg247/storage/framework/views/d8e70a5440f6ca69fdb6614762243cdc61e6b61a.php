            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Create Major Marketer</h4>
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        ...
                        <div class='display-inline-block width-50' >
                           ...
                           <form id='createMajorMarketerForm'>
                               
                                <div class='text-center'>
                                    <img class='picture' id='picture' class='border-radius-50' src='images/default-pic.png' style='max-width:200px;max-height:200px;' />
                              
                                    <input  type='file' name='imageMajorMarketer' class='imageMajorMarketer margin-top-20'  />
                                    <br>
                                    <input type='text' name='marketer_logo' id='photo' class='hide' />
                                ...
                                <div class='col-sm-12'>
                                    <div class='row'>
                                        <div class='col-sm-12 margin-top-20'>
                                            <input type='text' name='marketer_name'     class='form-control' required=''     placeholder='Marketer Name' />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <button type='button' id='addMajorMarketerBtn' class='btn margin-top-20 btn-primary width-100'>Add &nbsp; <i class="fa fa-spinner fa-spin hide " aria-hidden="true"></i></button>
...
</html><?php /**PATH /home/lpg247/public_html/resources/views/admin/createMajorMarketer.blade.php ENDPATH**/ ?>