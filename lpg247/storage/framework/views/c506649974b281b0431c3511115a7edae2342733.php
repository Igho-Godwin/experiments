    ...
    <div id="main-wrapper">
        ...
        <header class="topbar">
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">
                                <img src="<?php if($main_user->picture == null): ?>images/default-pic.png <?php else: ?> <?php echo e($main_user->picture); ?> <?php endif; ?>" alt="user" class="rounded-circle" width="31">
                            </a>
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <div class="d-flex no-block align-items-center p-15 bg-primary text-white m-b-10">
                                    <div class="">
                                        <img src="<?php if($main_user->picture == null): ?>images/default-pic.png <?php else: ?> <?php echo e($main_user->picture); ?> <?php endif; ?>" alt="user" class="img-circle rounded-circle" width="60">
                                    </div>
                                    <div class="m-l-10">
          ...
          <aside class="left-sidebar">
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li>
                            ...
                            <div class="user-profile dropdown m-t-20">
                                <div class="user-pic">
                                    <img src="<?php if(Auth::guard('sub_users')->user()->picture == null): ?>images/default-pic.png <?php else: ?> <?php echo e(Auth::guard('sub_users')->user()->picture); ?> <?php endif; ?>" alt="users" class="rounded-circle img-fluid" />
                                </div>
                                <div class="user-content hide-menu m-t-10">
                                    <h5 class="m-b-10 user-name font-medium"><?php echo e(Auth::guard('sub_users')->user()->fullName); ?></h5>
            ...
            <!-- End Sidebar scroll-->
        </aside><?php /**PATH /home/lpg247/public_html/resources/views/subUser/header/header.blade.php ENDPATH**/ ?>