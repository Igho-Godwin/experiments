...
<?php echo $__env->make('admin.header.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Sales Reps</h4>
                        ...
                        <div class="d-flex no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">All Sales Reps</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <!-- ============================================================== -->
                    ...
                    <div class="row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class='sales-rep-table hide' style='max-width:100%;overflow:auto;'>
        ...
        <thead>
            <tr>
                ...
                <th>Phone Number</th>
                <th>Company</th>
                <th>Location Of Depot</th>
                <th>Product To Sell</th>
                <th>Registration Date</th>
                <th>Verify</th>
                <th>Suspend</th>
            </tr>
        </thead>
        <tbody id='sales_rep_rows'>
            ...
            <tr>
                ...
                <th>Suspend</th>
                                    ...
                                    <div class='float-right '>
                                        ...
                                        <ul class="pagination sales-rep-pagination"></ul>
                                    </div>
...
</html><?php /**PATH /home/lpg247/public_html/resources/views/admin/allSalesRepPage.blade.php ENDPATH**/ ?>