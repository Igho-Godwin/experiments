            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <div class='margin-top-50px' style='display:inline-block'>
                             <input title='Amount' id='amount' name='amount' class="form-control" type="text" required=" " placeholder="Amount"/>

                             <button class='btn margin-top-20 btn-primary width-100' onClick='payWithPaystack()'>Fund wallet&nbsp;<i class='fa fa-spinner fa-spin hide'></i></button>
                        </div>
                    </div>
                </div>
...
<script>
  function payWithPaystack(){
    var handler = PaystackPop.setup({
      key: 'pk_test_4fce32e949e1f4aca27d62ab68038ee0f71b42f9',
      email: '<?php echo e(Auth::user()->email); ?>',
      amount: parseInt($('#amount').val())*100,
      currency: "NGN",
      ref: ''+Math.floor((Math.random() * 1000000000) + 1), // generates a pseudo-unique reference. Please replace with a reference you generated. Or remove the line entirely so our API will generate one for you
      firstname: '<?php echo e(Auth::user()->fullName); ?>',
      lastname: '',
      ...
      callback: function(response){
          ...
          logReferenceNo(response.reference);
  ...
  function logReferenceNo(reference_no)
  {
      $('.fa-spin').removeClass('hide');
       $.ajax({
            url: "api/pay/logPayment",
            method: "post",
            headers: {
               'Accept':'application/json',
            },
            data:{'user_id':<?php echo e(Auth::id()); ?>,'reference_no':reference_no,'amount':$('#amount').val()}
       }).done(function(data) {
         
          if(typeof data.success !== 'undefined')
          {
            $('.fa-spin').addClass('hide');
            swal("Good job!",'Funding Successful', "success");
            location.reload();
          }
          else
          {
...
</html><?php /**PATH /home/lpg247/public_html/resources/views/user/e_wallet.blade.php ENDPATH**/ ?>