                ...
                <!-- ============================================================== -->
                    ...
                    <div class="row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class='text-center margin-top-20 load-circle' >
                                    
                                    <i class="fa fa-circle-o-notch fa-spin text-color-red" style='font-size:80px;' ></i>
                                </div>
                                
                                <div class='all-products-table hide' style='max-width:100%;overflow:auto;'>
            ...
            <tr>
                ...
                <th>Delete</th>
                                    ...
                                    <div class='float-right '>
                                        ...
                                        <ul class="pagination products-pagination"></ul>
                                    </div>
                    ...
                    <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-body">
                             <form id='editProductsForm'>
                                ...
                                <input type='text' id='product_id'  name='product_id' value='' class='hide' />
                                ...
                                <div class='col-sm-12'>
                                    ...
                                    <div class='row'>
                                        <div class='col-sm-12 margin-top-20'>
                                            <input type='text' id='product_name' name='product_name'         class='form-control' required=''        placeholder='Product Name'  value=''  />
                                        </div>
                                    </div>
                                    
                                </div>
                                
                                <button type='button' onclick='editProduct()' class='btn margin-top-20 btn-primary width-100'>Edit &nbsp; <i class="fa fa-spinner fa-spin hide " aria-hidden="true"></i>
                                </button>
...
</html><?php /**PATH /home/lpg247/public_html/resources/views/admin/all_products.blade.php ENDPATH**/ ?>