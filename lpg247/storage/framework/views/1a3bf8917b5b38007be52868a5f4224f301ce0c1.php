...
<?php echo $__env->make('user.header.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">All Sub Accounts</h4>
                        ...
                        <div class="d-flex no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">All Sub Accounts</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
        ...
        <tbody>
            ...
            <?php $__currentLoopData = $sub_accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            
                <tr>
                    
                    <td>
                        <a href='' data-toggle="modal" data-target="#exampleModal<?php echo e($val->id); ?>" ><?php echo e($val->email); ?></a>
                    </td>
                    <td><?php echo e($val->address); ?></td>
                    <td><a href='allMarketersOrdersPage?id=<?php echo e($val->id); ?>'>View Orders</a></td>
                    <td>
                    
                            <i class="fa fa-pause pointer suspend <?php if($val->active == 0): ?> hide <?php endif; ?>" aria-hidden="true" data-value='<?php echo e($val->id); ?>' title='Suspend' ></i>
                    
                            <i class="fa fa-play pointer  <?php if($val->active == 1): ?> hide <?php endif; ?> unsuspend" aria-hidden="true" data-value='<?php echo e($val->id); ?>' title='Un-Suspend' ></i>
                ...
                <?php 
                    ...
                    <script>
                            ...
                            function subAccountAutoComplete".$val->id."(){
            
                                autocomplete".$val->id." = new google.maps.places.Autocomplete(
                                document.getElementById('autocomplete".$val->id."'), {types: ['geocode']});
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Sub Account</h5>
                                 <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                 </button>
                        </div>
                        <div class="modal-body">
                             <form id='editSubAccountForm<?php echo e($val->id); ?>'>
                               
                                <input type='text'  name='id' value='<?php echo e($val->id); ?>' class='hide' />
    
                                <div class='col-sm-12'>
                                    <div id='error<?php echo e($val->id); ?>' class='error_color margin-top-20'></div>
                                </div>
                                ...
                                <div class='col-sm-12'>
                                    ...
                                    <div class='row'>
                                        <div class='col-sm-12 margin-top-20'>
                                            <input type='text' name='email'         class='form-control' required=''        placeholder='Email Address'  value='<?php echo e($val->email); ?>'  />
                                        </div>
                                    </div>
                                ...
                                <div class='col-sm-12'>
                                    ...
                                    <div class='row'>
                                        <div class='col-sm-12 margin-top-20'>
                                           <input type='text' id='autocomplete<?php echo e($val->id); ?>' name='address'            class='form-control' value='<?php echo e($val->address); ?>' required=''     placeholder='Address' />
                                        </div>
                                    </div>
                                ...
                                <div class='col-sm-12'>
                                    ...
                                    <div class='row'>
                                        <div class='col-sm-12 margin-top-20'>
                                           <input type='text' name='price_per_qty'  class='form-control' required='' value='<?php echo e($val->price_per_qty); ?>'    placeholder='<?php if(Auth::user()->marketer_type == 0): ?> Enter Price Per Kilos <?php else: ?> Enter Price Per Tonne <?php endif; ?>' />
                                        </div>
                                    </div>
                                ...
                                <div class='col-sm-12'>
                                    ...
                                    <div class='row'>
                                        <div class='col-sm-12 margin-top-20'>
                                           <select name='city_of_location' class="form-control">
                                            <option value='' >Select</option>
                                            <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option <?php if($dt->name == $val->city): ?> Selected <?php endif; ?>><?php echo e($dt->name); ?></option>
                                ...
                                <button type='button' onclick='editSubAccountData(<?php echo e($val->id); ?>)' class='btn margin-top-20 btn-primary width-100'>Edit &nbsp; <i class="fa fa-spinner fa-spin hide " aria-hidden="true"></i></button>
    ...
    <div class='float-right'>
        <?php if($sub_accounts !=null && count($sub_accounts) > 0): ?>
               <?php echo e($sub_accounts->links()); ?>
...
</html><?php /**PATH /home/lpg247/public_html/resources/views/user/marketer/allSubAccounts.blade.php ENDPATH**/ ?>