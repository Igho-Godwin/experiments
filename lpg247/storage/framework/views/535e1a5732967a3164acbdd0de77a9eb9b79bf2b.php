            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Add Percentage Remission</h4>
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item">
                                        <a href="#">Percentage Remission</a>
                                    </li>
                                    <li class="breadcrumb-item active" aria-current="page">Add Percentage Remission</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class='display-inline-block width-50' >
                           ...
                           <form id='addRemissionForm'>
                                ...
                                <div class='col-sm-12'>
                                    <div class='row'>
                                        <div class='col-sm-12 margin-top-20'>
                                            <input type='text' title='Percentage Remission To admin e.g 10' name='percentage_remission'     class='form-control' required='' value='<?php if(isset($remission->first()->percentage_remission)): ?><?php echo e($remission->first()->percentage_remission); ?><?php endif; ?>'    placeholder='Percentage Remission To admin e.g 10' />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class='col-sm-12'>
                                    <div class='row'>
                                        <div class='col-sm-12 margin-top-20'>
                                            <input type='text' title='Percentage Remission To Referral e.g 10' name='percentage_remission'     class='form-control' required='' value='<?php if(isset($remission->first()->percentage_remission)): ?><?php echo e($remission->first()->percentage_remission); ?><?php endif; ?>'    placeholder='Percentage Remission To Referral e.g 10' />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <button type='button' id='addRemissionBtn' class='btn margin-top-20 btn-primary width-100'>Add &nbsp; <i class="fa fa-spinner fa-spin hide " aria-hidden="true"></i></button>
...
</html><?php /**PATH /home/lpg247/public_html/resources/views/admin/add_percentage_remission.blade.php ENDPATH**/ ?>