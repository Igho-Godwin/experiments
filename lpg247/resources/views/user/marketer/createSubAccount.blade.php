                    ...
                    <div class="col-sm-12 text-center">
                        ...
                        <div class='display-inline-block width-50' >
                           ...
                           <form id='addSubAccountForm'>
                                ...
                                <input type='text' name='user_id' value='{{Auth::id()}}' class='hide' />
                                ...
                                <div class='col-sm-12'>
                                    ...
                                    <div class='row'>
                                        <div class='col-sm-12 margin-top-20'>
                                           <input type='text' name='price_per_qty'  class='form-control' required=''     placeholder='@if(Auth::user()->marketer_type == 0) Enter Price Per Kilos @else Enter Price Per Tonne @endif' />
                                        </div>
                                    </div>
