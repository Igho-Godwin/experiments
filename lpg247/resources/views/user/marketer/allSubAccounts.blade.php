...
@include('user.header.header')
        ...
        <tbody>
            ...
            @foreach($sub_accounts as $val)
                ...
                <tr>
                    ...
                    <td>
                        <a href='' data-toggle="modal" data-target="#exampleModal{{$val->id}}" >{{$val->email}}</a>
                    </td>
                    <td>{{$val->address}}</td>
                    <td><a href='allMarketersOrdersPage?id={{$val->id}}'>View Orders</a></td>
                    <td>
                    
                            <i class="fa fa-pause pointer suspend @if($val->active == 0) hide @endif" aria-hidden="true" data-value='{{$val->id}}' title='Suspend' ></i>
                    
                            <i class="fa fa-play pointer  @if($val->active == 1) hide @endif unsuspend" aria-hidden="true" data-value='{{$val->id}}' title='Un-Suspend' ></i>
                ...
                <div class="modal fade" id="exampleModal{{$val->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-body">
                             <form id='editSubAccountForm{{$val->id}}'>
                               
                                <input type='text'  name='id' value='{{$val->id}}' class='hide' />
    
                                <div class='col-sm-12'>
                                    <div id='error{{$val->id}}' class='error_color margin-top-20'></div>
                                </div>
                                ...
                                <div class='col-sm-12'>
                                    ...
                                    <div class='row'>
                                        <div class='col-sm-12 margin-top-20'>
                                            <input type='text' name='email'         class='form-control' required=''        placeholder='Email Address'  value='{{$val->email}}'  />
                                        </div>
                                    </div>
                                ...
                                <div class='col-sm-12'>
                                    ...
                                    <div class='row'>
                                        <div class='col-sm-12 margin-top-20'>
                                           <input type='text' id='autocomplete{{$val->id}}' name='address'            class='form-control' value='{{$val->address}}' required=''     placeholder='Address' />
                                        </div>
                                    </div>
                                ...
                                <div class='col-sm-12'>
                                    ...
                                    <div class='row'>
                                        <div class='col-sm-12 margin-top-20'>
                                           <input type='text' name='price_per_qty'  class='form-control' required='' value='{{$val->price_per_qty}}'    placeholder='@if(Auth::user()->marketer_type == 0) Enter Price Per Kilos @else Enter Price Per Tonne @endif' />
                                        </div>
                                    </div>
                                        ...
                                        <div class='col-sm-12 margin-top-20'>
                                           <select name='city_of_location' class="form-control">
                                            ...
                                            @foreach($cities as $dt)
                                                <option @if($dt->name == $val->city) Selected @endif>{{$dt->name}}</option>
                                            @endforeach
                                        </select>
                                        </div>
                                    </div>
                                ...
                                <button type='button' onclick='editSubAccountData({{$val->id}})' class='btn margin-top-20 btn-primary width-100'>Edit &nbsp; <i class="fa fa-spinner fa-spin hide " aria-hidden="true"></i></button>
    ...
    <div class='float-right'>
        @if($sub_accounts !=null && count($sub_accounts) > 0)
               {{$sub_accounts->links()}}
        @endif
    </div>
