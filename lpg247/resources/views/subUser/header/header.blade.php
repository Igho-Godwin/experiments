                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">
                                <img src="@if($main_user->picture == null)images/default-pic.png @else {{$main_user->picture}} @endif" alt="user" class="rounded-circle" width="31">
                            </a>
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <div class="d-flex no-block align-items-center p-15 bg-primary text-white m-b-10">
                                    <div class="">
                                        <img src="@if($main_user->picture == null)images/default-pic.png @else {{$main_user->picture}} @endif" alt="user" class="img-circle rounded-circle" width="60">
                                    </div>
                                    <div class="m-l-10">
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li>
                            ...
                            <div class="user-profile dropdown m-t-20">
                                <div class="user-pic">
                                    <img src="@if(Auth::guard('sub_users')->user()->picture == null)images/default-pic.png @else {{Auth::guard('sub_users')->user()->picture}} @endif" alt="users" class="rounded-circle img-fluid" />
                                </div>
                                <div class="user-content hide-menu m-t-10">
                                    <h5 class="m-b-10 user-name font-medium">{{Auth::guard('sub_users')->user()->fullName}}</h5>
