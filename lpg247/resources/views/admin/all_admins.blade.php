...
@include('admin.header.header')
        ...
        <tbody>
            ...
            @foreach($all_admins as $val)
            
                <tr>
                    <td>{{$val->first_name}}</td>
                    <td>{{$val->last_name}}</td>
                    <td><a href='' data-toggle="modal" data-target="#exampleModal{{$val->id}}" >{{$val->email}}</a></td>
                    <td>
                ...
                <div class="modal fade" id="exampleModal{{$val->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-body">
                             <form id='editAdminForm{{$val->id}}'>
                               
                                <div class='text-center image'>
                                    <img class='picture' class='border-radius-50' src='{{$val->picture}}' style='max-width:200px;max-height:200px;' />
                                    <br>
                                    <input  type='file' name='image' class='image' />
                                    <br>
                                    <input type='text' name='photo' id='photo{{$val->id}}' class='hide' />
                                  
                                </div>
                            
                                <input type='text' id='id' name='id' value='{{$val->id}}' class='hide' />
                                ...
                                <div class='col-sm-12'>
                                    ...
                                    <div class='row'>
                                        <div class='col-sm-6 margin-top-20'>
                                            <input type='text' name='first_name'     class='form-control' required=''     placeholder='First Name' value='{{$val->first_name}}' />
                                        </div>
                                
                                        <div class=' col-sm-6 margin-top-20'>
                                             <input type='text' name='last_name'     class='form-control' required=''     placeholder='Last Name' value='{{$val->last_name}}' />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <button type='button' onclick='editAdminData({{$val->id}})' class='btn margin-top-20 btn-primary width-100'>Edit &nbsp; <i class="fa fa-spinner fa-spin hide " aria-hidden="true"></i></button>
    ...
    <div class='float-right'>
        @if($all_admins !=null && count($all_admins) > 0)
               {{$all_admins->links()}}
        @endif
    </div>
