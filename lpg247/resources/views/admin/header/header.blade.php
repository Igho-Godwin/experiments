                                ...
                                <ul class="list-style-none">
                                    ...
                                    <li>
                                        <div class="message-center message-body">
                                            ...
                                            <a href="javascript:void(0)" class="message-item">
                                                <span class="user-img">
                                                    <img src="{{$user->picture}}" alt="user" class="rounded-circle">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <div class="d-flex no-block align-items-center p-15 bg-primary text-white m-b-10">
                                    <div class="">
                                        <img src="{{$user->picture}}" alt="user" class="img-circle" width="60">
                                    </div>
                                    <div class="m-l-10">
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li>
                            ...
                            <div class="user-profile dropdown m-t-20">
                                <div class="user-pic">
                                    <img src="{{$user->picture}}" alt="users" class="rounded-circle img-fluid" />
                                </div>
                                <div class="user-content hide-menu m-t-10">
                                    <h5 class="m-b-10 user-name font-medium">{{$user->first_name}} {{$user->last_name}}</h5>
