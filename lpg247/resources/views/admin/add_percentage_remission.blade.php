                        ...
                        <div class='display-inline-block width-50' >
                           ...
                           <form id='addRemissionForm'>
                                ...
                                <div class='col-sm-12'>
                                    <div class='row'>
                                        <div class='col-sm-12 margin-top-20'>
                                            <input type='text' title='Percentage Remission To admin e.g 10' name='percentage_remission'     class='form-control' required='' value='@if(isset($remission->first()->percentage_remission)){{$remission->first()->percentage_remission}}@endif'    placeholder='Percentage Remission To admin e.g 10' />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class='col-sm-12'>
                                    <div class='row'>
                                        <div class='col-sm-12 margin-top-20'>
                                            <input type='text' title='Percentage Remission To Referral e.g 10' name='percentage_remission'     class='form-control' required='' value='@if(isset($remission->first()->percentage_remission)){{$remission->first()->percentage_remission}}@endif'    placeholder='Percentage Remission To Referral e.g 10' />
                                        </div>
                                    </div>
                                </div>
